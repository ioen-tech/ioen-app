...
// GET: Return Emails
// ------------------------------------------------
mock.onGet('/apps/ioen-mail/mail').reply(config => {
  ...
  const filteredData = data.mail.filter(
    email =>
  ...
  // ------------------------------------------------
  const emailsMeta = {
    inbox: data.mail.filter(email => !email.isDeleted && !email.isRead && email.folder === 'inbox').length,
    draft: data.mail.filter(email => email.folder === 'draft').length,
    spam: data.mail.filter(email => !email.isDeleted && !email.isRead && email.folder === 'spam').length,
  }
...
// POST: Update Email
// ------------------------------------------------
mock.onPost('/apps/ioen-mail/update-mail').reply(config => {
...
// ------------------------------------------------
mock.onPost('/apps/ioen-mail/update-mail-label').reply(config => {
...
// ------------------------------------------------
mock.onGet('/apps/ioen-mail/paginate-mail').reply(config => {
  const { dir, emailId } = config.params

  const currentEmailIndex = data.mail.findIndex(e => e.id === emailId)

  const newEmailIndex = dir === 'previous' ? currentEmailIndex - 1 : currentEmailIndex + 1

  const newEmail = data.mail[newEmailIndex]
