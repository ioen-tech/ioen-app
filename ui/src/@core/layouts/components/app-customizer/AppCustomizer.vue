<template>
  <div class="app-customizer">
    <v-btn icon class="app-customizer-toggler" color="white" large @click="isCustomizerOpen = !isCustomizerOpen">
      <v-icon size="25">
        {{ icons.mdiCog }}
      </v-icon>
    </v-btn>
    ...
    >
      ...
      <div class="app-customizer-header customizer-section py-3">
        <h6 class="font-weight-semibold text-xl text--primary">THEME CUSTOMIZER</h6>
        <span class="text--secondary">Customize and preview in real time</span>
        <v-btn icon class="icon-customizer-close" @click="isCustomizerOpen = false">
          <v-icon>
            {{ icons.mdiClose }}
          </v-icon>
        </v-btn>
      ...
      <perfect-scrollbar :options="perfectScrollbarOptions" class="ps-customizer">
        <!-- Section: Themeing -->
        <div class="customizer-section">
          ...
          <div class="d-flex align-center">
            ...
            <v-switch v-model="isDark" hide-details class="mt-0 mx-2"></v-switch>
        ...
        <div class="customizer-section">
          ...
          <v-radio-group v-model="appContentWidth" class="mt-1" hide-details row>
            <v-radio
          ...
          <div class="d-flex align-center justify-space-between mt-6">
            ...
            <v-switch v-model="appBarIsBlurred" hide-details class="mt-0 ms-2"></v-switch>
          </div>
        </div>
        ...
        <div class="customizer-section">
          ...
          <template v-if="$vuetify.breakpoint.lgAndUp">
            ...
            <v-radio-group v-model="appContentLayoutNav" class="mt-1" hide-details row>
              <v-radio
          ...
          <!-- Menu Collapsed -->
          <div v-if="appContentLayoutNav === 'vertical'" class="d-flex align-center justify-space-between mt-6">
            <span class="text--primary">Menu Collapsed</span>
            <v-switch v-model="menuIsVerticalNavMini" hide-details class="mt-0 ms-2"></v-switch>
          </div>

          <!-- Menu Hidden -->
          <div class="d-flex align-center justify-space-between mt-6">
            <span class="text--primary">Menu Hidden</span>
            <v-switch v-model="menuIsMenuHidden" hide-details class="mt-0 ms-2"></v-switch>
          </div>
        </div>
        <v-divider></v-divider>
        <!-- Section: Misc -->
