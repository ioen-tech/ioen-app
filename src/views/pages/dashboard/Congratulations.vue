  ...
  <v-card>
    <v-row class="ma-0 pa-0">
      <v-col cols="8" sm="6">
        ...
        <v-card-text>
          <span>You have contributed</span>
          <span class="text--primary font-weight-semibold">1 MegaWatt</span>
          <span class="text--primary font-weight-semibold"> 🤩 of Solar Power</span>
