<template>
  <v-card>
    ...
    <v-card-text class="d-flex align-center justify-space-between pb-1 pt-5">
      <div>
        <p class="text-5xl font-weight-semibold text--primary mb-2">147,466</p>
        <span class="text-base">Total Revenue</span>
      </div>
    ...
    <v-card-text class="mt-2">
      ...
      >
        ...
        <span class="font-weight-semibold text--primary me-6">⚡️{{ data.traffic }}</span>
